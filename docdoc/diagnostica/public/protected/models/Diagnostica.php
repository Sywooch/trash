 ...
 */
class Diagnostica extends StatusEntity
{
...
/*    
    public function getShortDescription($symbs = 600){
		$str = "";
		$words = explode(" ", $this->meta_description);
 ...
 */   
    public function getShortDescription($paragraphs = 2){
        $arr = explode('</p>', $this->meta_description);
