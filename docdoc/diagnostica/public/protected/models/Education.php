...
class Education extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, acronym', 'filter', 'filter' => 'strip_tags'),
			array('name', 'required'),
			array('name, acronym', 'length', 'max'=>512),
	...
	public function relations()
	{
		...
		return array(
			'doctors' => array(self::HAS_MANY, 'Doctor', 'education_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'acronym' => 'Аббревиатура учебного заведения',
		);
	}
