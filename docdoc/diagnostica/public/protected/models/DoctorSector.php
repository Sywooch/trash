 ...
 */
class DoctorSector extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return DoctorSector the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('doctor_id, sector_id, experience_year', 'required'),
			array('doctor_id, sector_id, best, experience_year', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('doctor_id, sector_id, best, experience_year', 'safe', 'on'=>'search'),
		);
	}
