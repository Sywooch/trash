...
return array(
	'params'     => array(
		'env'     => 'dev',
		'hosts'   => [
			'front'       => 'front.releaseui.docdoc.pro',
			'back'        => 'back.releaseui.docdoc.pro',
			'diagnostica' => 'diagnostica.releaseui.docdoc.pro',
			'static'      => 's.releaseui.docdoc.pro',
		],
		'booking' => array(
	...
	'components' => array(
		...
		'db'       => array(
			'connectionString' => 'mysql:host=localhost;dbname=docdoc_releaseui',
			'username'         => 'releaseui',
			'password'         => 'hkjnKJhjkn',
		),
		'fixture'  => array(
