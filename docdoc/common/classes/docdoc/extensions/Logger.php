...
class Logger extends CLogger
{
	...
	/**
	 * Массив того, что нужно принудительно трасировать
	 *
	 * @var array
	 */
	protected $forceTrace = [];
	...
	{
		if (array_key_exists($category, $this->forceTrace) && in_array($level, $this->forceTrace[$category])) {
			$message .= "\nStack trace:\n";
	 ...
	 */
	protected function filterTimingByCategory($value)
	{
