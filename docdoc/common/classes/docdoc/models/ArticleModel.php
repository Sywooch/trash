...
class ArticleModel extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'section' => array(self::BELONGS_TO, 'ArticleSection', 'article_section_id'),
		);
	}
	...
	{
		$count = static::model()->count("article_section_id=:section AND disabled=0", array(":section" => $section));
