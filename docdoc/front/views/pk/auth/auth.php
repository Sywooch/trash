<?php
$emailPartner = Yii::app()->params['email']['partner'];
$user = Yii::app()->user;
?>

<div class="reg_form__holder">
	<form id="lk-login-form" class="reg_form" method="post" action="/pk/service/login">
		<h1 class="reg_form__title">Партнерский кабинет</h1>
		...
		<p><a class="reg_form__link" href="/pk/recoveryPassword">Забыли пароль?</a></p>
	...
	<div class="reg_form__info">
		<p class="reg_form__desc">
			...
			<strong class="reg_form__contact">
				email: <a class="reg_form__link" href="mailto:<?php echo $emailPartner; ?>"><?php echo $emailPartner; ?></a>
				<br/>
