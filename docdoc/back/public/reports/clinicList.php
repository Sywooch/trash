<?php
	...
	$clinicType	= ( isset($_GET["clinicType"]) ) ? checkField ($_GET["clinicType"], "e", "clinic", false, array('clinic', 'center')) : "clinic";
	$withBranch	= ( isset($_GET["withBranch"]) ) ? checkField ($_GET["withBranch"], "i", "") : "";
	...
	$params['city']		= $city;
	$params['status']	= '3';
	$params['type']		= $clinicType;
	$params['branch'] = (!empty($withBranch) && $withBranch == 1)? true : false;
