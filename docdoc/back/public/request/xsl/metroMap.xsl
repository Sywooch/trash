		...
		<div style="width: 800px;">
			<div class="change-metro">
				<div id="metro_lines">
					...
					<a id="metro-clear-act" href="#" style="display: block;">очистить все выбранные</a>
					<div style="margin-top: 20px">
						<span class="form" style="padding: 3px 15px 2px 15px; margin: 0 0 0px 10px; width: 200px" onclick="setMetroFilter($stationsSelectName);">ВЫБРАТЬ</span>	
					</div>
				</div>
				
	<div id="map_moscow">
		<div style="background:url('/img/common/map_moscow.gif') no-repeat; width:605px; height:714px;"></div>
        <div id="map_stations">
