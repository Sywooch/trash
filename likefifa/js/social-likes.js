...
(function(factory) {  // Try to register as an anonymous AMD module
	...
	var services = {
		...
		vkontakte: {
			counterUrl: protocol + '//vk.com/share.php?act=count&url={url}&index={index}&image={image}&description={description}',
			...
			popupUrl: protocol + '//vk.com/share.php?url={url}&title={title}&image={image}&description={description}',
			popupWidth: 550,
			popupHeight: 330
		},
		odnoklassniki: {
