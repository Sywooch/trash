<?php
use likefifa\extensions\image\CArray;
...
class Image_GD_Driver extends Image_Driver {
    ...
    public function watermark($properties)
    {
        ...
        if(gettype($properties['image']) == 'class')
        {
            ...
            if(is_null($properties['left']))
                $properties['left'] = $width - $properties['image']->width - 10;

            if(is_null($properties['top']))
                $properties['top'] = $height - $properties['image']->height - 10;
        ...
        else if($width > 550)
        {
            ...
            $textDim = imagettfbbox(8, 0, $font, $properties['image']);
            ...
            imagettftext($img, 8, 0, 5, $height - 3, $letter_color, $font, $properties['image']);
        }
