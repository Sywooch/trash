...
class phpExifReader {
    ...
    */
    function getImageInfo() {
        ...
        if(isset($imgInfo["Width"]) && isset($imgInfo["Height"])) $retArr["resolution"] = $imgInfo["Width"]."x".$imgInfo["Height"];
        ...
        if(isset($imgInfo["IsColor"])) $retArr["color"] = ($imgInfo["IsColor"] == 0) ? "Black and white" : "Color";
