...
$base_url="/upload/news/";  // DON'T TOUCH (base url (only domain) of site (without final /)).
...
$current_path =
	...
	DIRECTORY_SEPARATOR .
	"news" .
	'/source/'; // relative path from filemanager folder to upload folder (with final /)
...
$thumbs_base_path =
	...
	DIRECTORY_SEPARATOR .
	"news" .
	'/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
