...
.cliniclist-uzilab2 .dd-clinic .dd-img {
	position: absolute;
	top: 0;
	bottom: 0;
	left: 0;
...
.cliniclist-uzilab2 .dd-clinic .dd-img img {
	vertical-align: top;
	width: 150px;
	height: auto;
}

.cliniclist-uzilab2 .dd-clinic .dd-r {
	float: right;
	width: 205px;
...
.cliniclist-uzilab2 .dd-clinic .dd-r a {
	display: block;
...
.cliniclist-uzilab2 .dd-clinic .dd-name,
.cliniclist-uzilab2 .dd-name a {
	font-size: 16px;
	color: #000;
	margin: 0 0 7px 0;
	text-decoration: none;
...
.cliniclist-uzilab2 .dd-name a:hover {
	color: #0169d9;
	text-decoration: underline;
}

.cliniclist-uzilab2 .dd-button {
	margin: 0 auto 19px auto;
	text-decoration: none;
	background: #4A9CF6;
...
.cliniclist-uzilab2 .dd-button span {
	color: #fff;
	font: normal 14px/30px Arial, Helvetica, sans-serif;
	border: 0;
	box-shadow: none;
...
.cliniclist-uzilab2 .dd-button:hover {
...
.cliniclist-uzilab2 .dd-uzilab-footer a {
	color: #000;
	text-decoration: none;
}

.cliniclist-uzilab2 .dd-uzilab-footer a:hover {
	color: #0169d9;
	text-decoration: underline;
}